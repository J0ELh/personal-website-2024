...
export const DesktopHomepage = () => {
    ...
    return (
    <div className="min-h-screen min-w-[320px] bg-gray-200 p-8 flex text-black">
            <div className="w-3/10 flex flex-col border-r-2 border-gray-400 pr-8 justify-between">
                <div className=''>
            ...
            <div className="w-7/10 pl-8">
                ...
                <nav className="flex justify-center items-center flex-col mt-10">
                    ...
                    <a 
                            ...
                            className='w-1/2 md:min-w-[320px] md:max-w-[450px] flex justify-center items-center text-lg m-2 p-3 bg-gray-300 rounded transition-colors duration-300 ease-in-out hover:bg-gray-400'
                        >
                        <div >
                            Experience (Resume)
                        </div>
